...
<div class="signup-form">
 ...
 <div class="row">
      ...
      <input aria-required="true" class="yj-validate last-name required wider pw-validate" id="LoginId" name="LoginId" size="30" type="text" />
...
<br><br>
    <div class="row">
        ...
        <button  type="submit" class="yj-btn"  ><span>Submit</span></button>
      </div>
    </div>
    </div>
